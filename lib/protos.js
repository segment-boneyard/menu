...
exports.next = function () {
  ...
  if (previous && previous.next(':not(.hidden)')[0]) next = previous.next(':not(.hidden)');
...
exports.previous = function () {
  ...
  if (previous && previous.previous(':not(.hidden)')[0]) next = previous.previous(':not(.hidden)');
